...
$app->get($route, function ($project_id)  use ($app,$appid,$appkey,$guser,$gpass){
	...
	if($ProjectResults && mysql_num_rows($ProjectResults))
		...
		while ($Tag = mysql_fetch_assoc($TagResult))
			...
			$PageBody = '<p>Currently working with ' . $company_count . ' companies, with ' . $api_count . ' APIs cataloged, and ' . $swagger_count . ' OADF, API Blueprint, and Postman collections available--you can access <a href="/apis.json">full APIs.json for this API collection</a> in the root of the website.</p>';
